...
function updatePageAction(tabId) {
  ...
  if (tabStorage !== undefined) {
    let printedIp = tabStorage.main.isCached
      ? browser.i18n.getMessage("pageActionCached")
      : tabStorage.main.ip;
    let title = browser.i18n.getMessage("pageActionTooltip", [
...
browser.webRequest.onResponseStarted.addListener((details) => {
  ...
  let isProxied =
    details.proxyInfo !== undefined &&
    details.proxyInfo !== null &&
  ...
  if (isMain) storageMap.delete(tabId);
